...
public class Test {
	...
	public static void main(String[] args) throws InvalidPasswordException, IOException {
		...
		try {
			pdfTextInserter(document,".",473,595);
			pdfTextInserter(document,".",571,595);
			pdfTextInserter(document,".",473,695);
			pdfTextInserter(document,".",571,695);
		} catch (Exception e) {
			e.printStackTrace();
		}
		pdfimageInserter(0,document,475,595,img2,"1","C:\\Users\\prade\\Downloads\\ekyc_pdf\\");
		
		document.save(new File("C:\\Users\\prade\\Downloads\\ekyc_pdf" + eKYCConstant.WINDOWS_FORMAT_SLASH + finalPDFName));
	...
	public static void pdfTextInserter(PDDocument document,String insertValue, int xValue, int yValue) throws Exception {
